...
public class FormImportItemJFrame extends javax.swing.JFrame {
    ...
    public boolean checkItem() {
        ...
        for (ProductItem item : listItem) {
            if (item.getIdProduct() == newProductItem.getIdProduct()//Cùng 1 sản phẩm
                    && item.getIdColor() == newProductItem.getIdColor()//Cùng 1 màu
                    && item.getIdMaterial() == newProductItem.getIdMaterial()//Cùng 1 chất liệu  
                    && item.getIdSize() == newProductItem.getIdSize())//Cùng 1 size
            {
                MsgBox.alert(this, "Mặt hàng đã có vui lòng thêm mặt hàng khác");
                return false;
            }
        }
        for (ProductItem item : list) {
            if (item.getIdProduct() == newProductItem.getIdProduct()//Cùng 1 sản phẩm
                    ...
                    && item.getIdSize() == newProductItem.getIdSize())//Cùng 1 size
            {
                MsgBox.alert(this, "Mặt hàng vừa được lưu tạm vui lòng thêm mặt hàng khác");
                return false;
            }
        }
        return true;
